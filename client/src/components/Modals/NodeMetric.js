...
const NodeMetric = ( {nodeName, nodeType, avgTime, avgVolume, failures } ) => {
  const [nodeBgColor, setNodeBgColor] = useState(nodeIconData[nodeType].bgColor);
  const [nodeAbbreviation, setNodeAbbreviation] = useState(nodeIconData[nodeType].abbreviation);
